...
4. start your dev server (or use `/preview up`), then in chat pick a worktree
...
- `/preview down [port] [instruction...]`: stop the dev server, then disable the preview
...
- `/preview down [port] [instruction...]` (stop + preview)
